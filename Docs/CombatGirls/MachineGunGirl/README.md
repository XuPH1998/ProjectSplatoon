...
现行11.3.0对齐：第一圈2秒33发、满蓄2.5秒66发，三阶段弹道与逐发散布偏置；行走3.95390／游泳7.76403／射击2.69584／蓄力1.97695米/秒。完整实现与最新验收见 [对齐报告](../../WeaponAlignment1130/Report.md)。下文中的旧参数和旧验收证据不代表本轮版本。
