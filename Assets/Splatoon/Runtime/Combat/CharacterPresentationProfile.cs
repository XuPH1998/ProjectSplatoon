...
namespace Splatoon.Combat
{
    ...
    public sealed class CharacterPresentationProfile : ScriptableObject
    {
        ...
        public Vector3 MuzzleOffset(float pitch, byte muzzle = 0) => AimPivot + Quaternion.Euler(pitch, 0, 0) * ((muzzle == 1 && DualWield ? LeftMuzzlePosition : MuzzlePosition) - AimPivot);
    }
}
