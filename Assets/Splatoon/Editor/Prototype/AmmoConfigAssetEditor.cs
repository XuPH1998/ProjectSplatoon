...
namespace Splatoon.Editor
{
    ...
    public sealed class AmmoConfigAssetEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            Draw("ammoId", "弹药编号");
            EditorGUILayout.Space(); EditorGUILayout.LabelField("泡泡表现与声音", EditorStyles.boldLabel);
            Draw("bubblePrefab", "泡泡网格预制体");
            Draw("bubbleShotAudio", "出泡声音");
            Draw("bubbleBounceAudio", "弹跳声音");
            Draw("bubblePopAudio", "破裂声音");
            ...
            Draw("explosionConstantDamage", "爆风固定伤害（不随距离衰减）");
            Draw("collisionExplosionRadiusRate", "碰撞早爆范围倍率");
            Draw("collisionExplosionDamageRate", "碰撞早爆伤害倍率");
            Draw("excludeDirectHitFromExplosion", "直击目标不重复承受爆风");
            ...
            if (ammo.explosionEnabled && ammo.explosionPrefab == null)
                EditorGUILayout.HelpBox("未绑定爆炸预制体：爆炸玩法仍生效，暂时使用普通命中效果。", MessageType.Info);
