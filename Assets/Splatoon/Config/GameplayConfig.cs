    ...
    public static class GameplayConfig
    {
        ...
        public static void Validate(cfg.Tables supplied = null)
        {
            ...
            foreach (var c in tables.TbHero.DataList)
            {
                ...
                Require(!string.IsNullOrWhiteSpace(c.SubWeaponConfigPath) && c.SubWeaponConfigPath.StartsWith("Assets/", StringComparison.Ordinal) && c.SubWeaponConfigPath.EndsWith(".asset", StringComparison.Ordinal), "副武器配置路径必须为 Assets/.../*.asset");
