...
float4 _FaceShadowMaskMap_ST;
float _FaceShadowMaskStrength;
float _FaceShadowOffset;
float _FaceShadowSoftness;
float4 _FaceForward;
float4 _FaceRight;
fixed _UseScriptVectors;
fixed _MirrorFaceShadowByLight;
float _FaceShadowMirrorBlend;
float _SDFFrontShadowSuppressStart;
float _SDFFrontShadowSuppressEnd;
float _SDFDebugMode;
